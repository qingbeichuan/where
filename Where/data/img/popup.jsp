...
.login_content_body .login_check_code .txt-login-input{background:#fff;width:114px;border:1px solid #ccc;padding:5px;margin:0}
.login_content_body .login_check_code .txt_igin_ico{width:75px;border:0;padding:5px 0;float:left}
.txt_login_ym{width:113px;float:left;border:1px solid #ccc;position:relative}
...
.login_btn_blue{width:105px;height:22px;line-height:22px;text-align:center;color:#fff;background-position:-38px -120px;cursor:pointer;text-indent:0;margin-top:5px}
...
.login_btn_gray{background:#f9f9f9;display:inline-block;border:1px solid #dedede;width:105px;height:20px;line-height:20px;text-align:center;margin-top:5px}
